...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;,
        Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppItem;,
        Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    }
.end annotation
...
# instance fields
.field mAppAdapter:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;
...
.method static synthetic access$000(Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;Ljava/lang/String;)V
    ...
    .prologue
    .line 70
    invoke-direct {p0, p1}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->removeCustomApplication(Ljava/lang/String;)V
...
.method static synthetic access$100(Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;Ljava/lang/String;)V
    ...
    .prologue
    .line 70
    invoke-direct {p0, p1}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->addCustomApplication(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$200(Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;)Landroid/content/pm/PackageManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$300(Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;Ljava/lang/String;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private addCustomApplication(Ljava/lang/String;)V
    ...
    .prologue
    .line 274
    iget-object v1, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;

    invoke-interface {v1, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;

    .line 275
    .local v0, app:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    if-nez v0, :cond_0

    .line 276
    new-instance v0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;

    .end local v0           #app:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    ...
    invoke-direct {v0, p1, v1, v2, v3}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;-><init>(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 277
    .restart local v0       #app:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    iget-object v1, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;
    ...
    invoke-direct {p0, v1}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->saveApplicationList(Z)V

    .line 279
    invoke-direct {p0}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->refreshCustomApplications()V
...
.method private parseApplicationList()Z
    ...
    iget-object v7, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplicationList:Ljava/lang/String;
    ...
    .line 298
    :cond_0
    iput-object v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplicationList:Ljava/lang/String;

    .line 299
    iget-object v7, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;
    ...
    .line 307
    :cond_2
    invoke-static {v5}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->fromString(Ljava/lang/String;)Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    ...
    iget-object v8, v0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->name:Ljava/lang/String;
...
.method private refreshCustomApplications()V
    ...
    invoke-direct {p0}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->parseApplicationList()Z
    ...
    .line 225
    .local v13, prefs:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/CharSequence;Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;>;"
    invoke-virtual {v6}, Landroid/preference/PreferenceGroup;->removeAll()V

    .line 227
    iget-object v2, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;
    ...
    check-cast v7, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;

    .line 229
    .local v7, i:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    :try_start_0
    iget-object v2, v7, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->name:Ljava/lang/String;
    ...
    new-instance v0, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;

    iget-object v2, v7, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->color:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v3

    iget-object v2, v7, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->timeon:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v4

    iget-object v2, v7, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->timeoff:Ljava/lang/Integer;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;-><init>(Landroid/content/Context;Landroid/view/View$OnLongClickListener;III)V

    .line 232
    .local v0, pref:Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;
    ...
    invoke-virtual {v0, v2}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setKey(Ljava/lang/String;)V

    .line 235
    invoke-virtual {v0, v10}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 238
    iget-object v2, v7, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->name:Ljava/lang/String;

    invoke-virtual {v0, v2}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 239
    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setPersistent(Z)V

    .line 240
    invoke-virtual {v0, p0}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    .line 243
    .end local v0           #pref:Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;
    ...
    .line 248
    .end local v7           #i:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    :cond_2
    ...
    check-cast v0, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;

    .line 249
    .restart local v0       #pref:Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;
...
.method private removeCustomApplication(Ljava/lang/String;)V
    ...
    .prologue
    .line 284
    iget-object v0, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->saveApplicationList(Z)V
...
.method private saveApplicationList(Z)V
    ...
    iget-object v4, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;
    ...
    .line 320
    .local v0, app:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;
    invoke-virtual {v0}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->toString()Ljava/lang/String;
...
.method private setCustomEnabled()V
    ...
    .prologue
    .line 256
    iget-boolean v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mCustomEnabled:Z

    if-eqz v3, :cond_2

    iget-boolean v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mLightEnabled:Z
    ...
    iget-boolean v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mVoiceCapable:Z

    if-eqz v3, :cond_0

    .line 260
    iget-object v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mCallPref:Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;

    invoke-virtual {v1}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v4

    invoke-virtual {v3, v4}, Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;->setEnabled(Z)V

    .line 261
    iget-object v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mVoicemailPref:Lcom/android/OriginalSettings/notificationlight/ApplicationLightPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 128
    iget-object v2, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-virtual {v2, v0, v4}, Landroid/content/pm/PackageManager;->queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;

    move-result-object v2

    iput-object v2, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mInstalledApps:Ljava/util/List;

    .line 129
    new-instance v2, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;

    iget-object v5, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mInstalledApps:Ljava/util/List;

    invoke-direct {v2, p0, v5}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;-><init>(Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;Ljava/util/List;)V

    iput-object v2, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mAppAdapter:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;

    .line 130
    iget-object v2, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mAppAdapter:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;

    invoke-virtual {v2}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;->update()V
    ...
    iput-object v2, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mApplications:Ljava/util/Map;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v3, p0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->mAppAdapter:Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$AppAdapter;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    new-instance v3, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$1;

    invoke-direct {v3, p0, v1}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$1;-><init>(Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;Landroid/widget/TextView;)V
...
.method protected updateValues(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    .line 364
    iput-object p2, v0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->color:Ljava/lang/Integer;

    .line 365
    iput-object p3, v0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->timeon:Ljava/lang/Integer;

    .line 366
    iput-object p4, v0, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings$Application;->timeoff:Ljava/lang/Integer;

    .line 367
    const/4 v2, 0x1

    invoke-direct {p0, v2}, Lcom/android/OriginalSettings/notificationlight/NotificationLightSettings;->saveApplicationList(Z)V
