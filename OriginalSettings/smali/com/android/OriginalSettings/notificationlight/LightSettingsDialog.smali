...
.field private mOldColor:Lcom/android/OriginalSettings/notificationlight/ColorPanelView;
...
.method protected constructor <init>(Landroid/content/Context;III)V
    ...
    invoke-direct {p0, p2, p3, p4, v0}, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->init(IIIZ)V
...
.method private setUp(IIIZ)V
    ...
    iput-object v2, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mOldColor:Lcom/android/OriginalSettings/notificationlight/ColorPanelView;
    ...
    .line 102
    iget-object v2, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mOldColor:Lcom/android/OriginalSettings/notificationlight/ColorPanelView;

    invoke-virtual {v2}, Lcom/android/OriginalSettings/notificationlight/ColorPanelView;->getParent()Landroid/view/ViewParent;

    move-result-object v2

    check-cast v2, Landroid/widget/LinearLayout;

    iget-object v5, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mColorPicker:Lcom/android/OriginalSettings/notificationlight/ColorPickerView;

    invoke-virtual {v5}, Lcom/android/OriginalSettings/notificationlight/ColorPickerView;->getDrawingOffset()F
    ...
    iget-object v6, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mColorPicker:Lcom/android/OriginalSettings/notificationlight/ColorPickerView;

    invoke-virtual {v6}, Lcom/android/OriginalSettings/notificationlight/ColorPickerView;->getDrawingOffset()F
    ...
    invoke-virtual {v2, p1}, Lcom/android/OriginalSettings/notificationlight/ColorPanelView;->setColor(I)V
    ...
    invoke-direct {v1, p0, v2, v5, v6}, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog$PulseSpeedAdapter;-><init>(Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;IILjava/lang/Integer;)V
    ...
    invoke-virtual {v1, v5}, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog$PulseSpeedAdapter;->getTimePosition(Ljava/lang/Integer;)I
    ...
    iget-object v5, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mSelectionListener:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    .line 127
    iget-object v5, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mPulseSpeedOff:Landroid/widget/Spinner;
...
.method public onColorChanged(I)V
    ...
    .prologue
    .line 147
    iget-object v0, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mNewColor:Lcom/android/OriginalSettings/notificationlight/ColorPanelView;

    invoke-virtual {v0, p1}, Lcom/android/OriginalSettings/notificationlight/ColorPanelView;->setColor(I)V

    .line 149
    iget-object v0, p0, Lcom/android/OriginalSettings/notificationlight/LightSettingsDialog;->mListener:Lcom/android/OriginalSettings/notificationlight/ColorPickerView$OnColorChangedListener;
    ...
    invoke-interface {v0, p1}, Lcom/android/OriginalSettings/notificationlight/ColorPickerView$OnColorChangedListener;->onColorChanged(I)V
