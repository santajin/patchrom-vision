.class public Lcom/android/OriginalSettings/cmstats/ReportingService;
.super Landroid/app/Service;
.source "ReportingService.java"


# static fields
.field protected static final TAG:Ljava/lang/String; = "CMStats"
...
.method static synthetic access$000(Lcom/android/OriginalSettings/cmstats/ReportingService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 42
    invoke-direct {p0}, Lcom/android/OriginalSettings/cmstats/ReportingService;->report()V
...
.method private promptUser()V
    ...
    invoke-virtual {p0, v4}, Lcom/android/OriginalSettings/cmstats/ReportingService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/android/OriginalSettings/cmstats/ReportingService;->getPackageName()Ljava/lang/String;

    move-result-object v5

    const-class v6, Lcom/android/OriginalSettings/Settings$AnonymousStatsActivity;
    ...
    invoke-virtual {p0, v9}, Lcom/android/OriginalSettings/cmstats/ReportingService;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Lcom/android/OriginalSettings/cmstats/ReportingService;->getString(I)Ljava/lang/String;
...
.method private report()V
    ...
    .prologue
    .line 69
    invoke-virtual {p0}, Lcom/android/OriginalSettings/cmstats/ReportingService;->getApplicationContext()Landroid/content/Context;

    move-result-object v10

    invoke-static {v10}, Lcom/android/OriginalSettings/cmstats/Utilities;->getUniqueID(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v10}, Lcom/android/OriginalSettings/cmstats/Utilities;->getCountryCode(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v10}, Lcom/android/OriginalSettings/cmstats/Utilities;->getCarrier(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v10}, Lcom/android/OriginalSettings/cmstats/Utilities;->getCarrierId(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v10, "http://stats.cyanogenmod.com/submit"
    ...
    invoke-virtual {p0, v10, v11}, Lcom/android/OriginalSettings/cmstats/ReportingService;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    .line 101
    invoke-virtual {p0}, Lcom/android/OriginalSettings/cmstats/ReportingService;->stopSelf()V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 53
    invoke-direct {p0}, Lcom/android/OriginalSettings/cmstats/ReportingService;->promptUser()V
    ...
    .line 57
    new-instance v0, Lcom/android/OriginalSettings/cmstats/ReportingService$1;

    invoke-direct {v0, p0}, Lcom/android/OriginalSettings/cmstats/ReportingService$1;-><init>(Lcom/android/OriginalSettings/cmstats/ReportingService;)V
