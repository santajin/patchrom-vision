...
.method private initializeRecorder()V
    ...
    iput v14, v0, Lcom/android/camera/VideoCamera;->mVideoWidth:I
    ...
    iput v14, v0, Lcom/android/camera/VideoCamera;->mVideoHeight:I
    ...
    .line 1222
    :cond_a
    iget v12, v4, Landroid/hardware/Camera$CameraInfo;->orientation:I
...
.method private setCameraParameters()V
    ...
    .line 1843
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;

    invoke-virtual {v11}, Lcom/android/camera/CameraManager$CameraProxy;->getParameters()Landroid/hardware/Camera$Parameters;

    move-result-object v11

    iput-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;
    ...
    .line 1848
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;

    const/4 v12, 0x0

    invoke-virtual {v11, v12}, Landroid/hardware/Camera$Parameters;->setRotation(I)V

    .line 1852
    :cond_0
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;

    invoke-static {v11, v14}, Lcom/android/camera/CameraSettings;->setVideoMode(Landroid/hardware/Camera$Parameters;Z)V

    .line 1855
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;

    iget-object v12, p0, Lcom/android/camera/VideoCamera;->mProfile:Landroid/media/CamcorderProfile;

    invoke-static {v11, v12}, Lcom/android/camera/CameraSettings;->setEarlyVideoSize(Landroid/hardware/Camera$Parameters;Landroid/media/CamcorderProfile;)V
    ...
    const-string v13, "Preview dimension in App->"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget v13, p0, Lcom/android/camera/VideoCamera;->mDesiredPreviewWidth:I
    ...
    iget v13, p0, Lcom/android/camera/VideoCamera;->mDesiredPreviewHeight:I
    ...
    iget v12, p0, Lcom/android/camera/VideoCamera;->mDesiredPreviewWidth:I
    ...
    invoke-virtual {v11, v12, v5}, Landroid/hardware/Camera$Parameters;->set(Ljava/lang/String;Ljava/lang/String;)V

    .line 1866
    iget-boolean v11, p0, Lcom/android/camera/VideoCamera;->mShowCameraAppView:Z

    if-eqz v11, :cond_8

    .line 1867
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mPreferences:Lcom/android/camera/ComboPreferences;
    ...
    invoke-static {v1, v7}, Lcom/android/camera/VideoCamera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v11, v1}, Landroid/hardware/Camera$Parameters;->setFlashMode(Ljava/lang/String;)V
    ...
    invoke-static {v10, v11}, Lcom/android/camera/VideoCamera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v11, v10}, Landroid/hardware/Camera$Parameters;->setWhiteBalance(Ljava/lang/String;)V
    ...
    iget v12, p0, Lcom/android/camera/VideoCamera;->mZoomValue:I
    ...
    .line 1905
    .local v8, supportedFocus:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    iget-boolean v11, p0, Lcom/android/camera/VideoCamera;->mCaptureTimeLapse:Z

    if-eqz v11, :cond_b

    const-string v11, "auto"

    invoke-static {v11, v8}, Lcom/android/camera/VideoCamera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v11, v14}, Landroid/hardware/Camera$Parameters;->setRecordingHint(Z)V

    .line 1915
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;

    const-string v12, "video-stabilization-supported"

    invoke-virtual {v11, v12}, Landroid/hardware/Camera$Parameters;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    .line 1916
    .local v9, vstabSupported:Ljava/lang/String;
    ...
    const-string v12, "video-stabilization"
    ...
    iget v11, p0, Lcom/android/camera/VideoCamera;->mDesiredPreviewWidth:I
    ...
    invoke-static {v6, v11, v12}, Lcom/android/camera/Util;->getOptimalVideoSnapshotPictureSize(Ljava/util/List;D)Landroid/hardware/Camera$Size;
    ...
    const-string v13, "Video snapshot size is "
    ...
    .line 1935
    iget v11, p0, Lcom/android/camera/VideoCamera;->mCameraId:I
    ...
    invoke-virtual {v11, v2}, Landroid/hardware/Camera$Parameters;->setJpegQuality(I)V
    ...
    const-string v13, "Color effect value ="
    ...
    invoke-static {v0, v11}, Lcom/android/camera/VideoCamera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v11, v0}, Landroid/hardware/Camera$Parameters;->setColorEffect(Ljava/lang/String;)V

    .line 1948
    :cond_7
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;

    invoke-static {v11}, Lcom/android/camera/CameraSettings;->dumpParameters(Landroid/hardware/Camera$Parameters;)V

    .line 1950
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;

    iget-object v12, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;
    ...
    iget v12, p0, Lcom/android/camera/VideoCamera;->mDesiredPreviewHeight:I

    invoke-direct {p0, v11, v12}, Lcom/android/camera/VideoCamera;->updateCameraScreenNailSize(II)V
    ...
    .end local v6           #supported:Ljava/util/List;,"Ljava/util/List<Landroid/hardware/Camera$Size;>;"
    .end local v7           #supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v8           #supportedFocus:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v9           #vstabSupported:Ljava/lang/String;
    ...
    .line 1877
    .restart local v7       #supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_9
    iget-object v11, p0, Lcom/android/camera/VideoCamera;->mParameters:Landroid/hardware/Camera$Parameters;
    ...
    invoke-virtual {v11}, Landroid/hardware/Camera$Parameters;->getWhiteBalance()Ljava/lang/String;
    ...
    .line 1907
    .restart local v8       #supportedFocus:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_b
