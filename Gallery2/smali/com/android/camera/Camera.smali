...
.field private static final CAMERA_TIMER:I = 0xe
...
.method private startPreview()V
    ...
    iget-object v2, p0, Lcom/android/camera/Camera;->mErrorCallback:Lcom/android/camera/Camera$CameraErrorCb;
    ...
    iget-boolean v1, p0, Lcom/android/camera/Camera;->mAspectRatioChanged:Z
    ...
    invoke-virtual {v1, v4}, Lcom/android/camera/FocusManager;->setAeAwbLock(Z)V
    ...
    invoke-static {v1, v4}, Lcom/android/camera/CameraSettings;->setVideoMode(Landroid/hardware/Camera$Parameters;Z)V
...
.method private switchCamera()V
    ...
    .line 2577
    iget-object v5, p0, Lcom/android/camera/Camera;->mPreviewFrameLayout:Lcom/android/camera/PreviewFrameLayout;

    iget v6, v1, Landroid/hardware/Camera$CameraInfo;->orientation:I

    invoke-virtual {v5, v6}, Lcom/android/camera/PreviewFrameLayout;->setCameraOrientation(I)V
...
.method private updateCameraParametersPreference()V
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/camera/FocusManager;->getAeAwbLock()Z

    move-result v28

    invoke-virtual/range {v27 .. v28}, Landroid/hardware/Camera$Parameters;->setAutoExposureLock(Z)V
    ...
    invoke-virtual/range {v27 .. v28}, Landroid/hardware/Camera$Parameters;->setAutoWhiteBalanceLock(Z)V
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/camera/FocusManager;->getFocusAreas()Ljava/util/List;

    move-result-object v28

    invoke-virtual/range {v27 .. v28}, Landroid/hardware/Camera$Parameters;->setFocusAreas(Ljava/util/List;)V
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/camera/FocusManager;->getMeteringAreas()Ljava/util/List;

    move-result-object v28

    invoke-virtual/range {v27 .. v28}, Landroid/hardware/Camera$Parameters;->setMeteringAreas(Ljava/util/List;)V
    ...
    invoke-virtual/range {v27 .. v29}, Lcom/android/camera/ComboPreferences;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v19

    .line 2229
    .local v19, pictureSize:Ljava/lang/String;
    if-nez v19, :cond_f
    ...
    .line 2252
    .local v17, optimalSize:Landroid/hardware/Camera$Size;
    move-object/from16 v0, p0
    ...
    .line 2253
    .local v18, original:Landroid/hardware/Camera$Size;
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/camera/CameraManager$CameraProxy;->setParameters(Landroid/hardware/Camera$Parameters;)V
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/camera/CameraManager$CameraProxy;->getParameters()Landroid/hardware/Camera$Parameters;
    ...
    invoke-static/range {v27 .. v28}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    iput v0, v1, Lcom/android/camera/Camera;->mSnapshotMode:I
    ...
    invoke-virtual/range {v27 .. v28}, Landroid/hardware/Camera$Parameters;->setCameraMode(I)V
    ...
    const-string v28, "pref_camera_jpeg_key"

    const v29, 0x7f0d006d
    ...
    invoke-virtual {v0, v13}, Landroid/hardware/Camera$Parameters;->setJpegQuality(I)V
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getSupportedIsoValues()Ljava/util/List;

    move-result-object v27

    move-object/from16 v0, v27

    invoke-static {v12, v0}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v0, v12}, Landroid/hardware/Camera$Parameters;->setISOValue(Ljava/lang/String;)V
    ...
    invoke-static/range {v27 .. v27}, Lcom/android/camera/CameraSettings;->readExposure(Lcom/android/camera/ComboPreferences;)I
    ...
    const-string v28, "pref_camera_flashmode_key"
    ...
    .line 2322
    .local v11, flashMode:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getSupportedFlashModes()Ljava/util/List;

    move-result-object v24

    .line 2323
    .local v24, supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    move-object/from16 v0, v24

    invoke-static {v11, v0}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v0, v11}, Landroid/hardware/Camera$Parameters;->setFlashMode(Ljava/lang/String;)V
    ...
    invoke-static/range {v26 .. v27}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/camera/FocusManager;->overrideFocusMode(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/camera/FocusManager;->getFocusMode()Ljava/lang/String;

    move-result-object v28

    invoke-virtual/range {v27 .. v28}, Landroid/hardware/Camera$Parameters;->setFocusMode(Ljava/lang/String;)V

    .line 2352
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/Camera;->getResources()Landroid/content/res/Resources;

    move-result-object v27

    const v28, 0x7f0d00f6
    ...
    .line 2353
    .local v7, defaultFocusTime:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v28, "pref_camera_focus_key"
    ...
    .line 2354
    .local v9, delayFocusTime:Ljava/lang/String;
    ...
    sput v27, Lcom/android/camera/ActivityBase;->mFocusTime:I
    ...
    .line 2358
    .local v8, defaultTime:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v28, "pref_camera_timer_key"
    ...
    .line 2359
    .local v10, delayTime:Ljava/lang/String;
    ...
    iput v0, v1, Lcom/android/camera/Camera;->mCaptureMode:I

    .line 2365
    .end local v7           #defaultFocusTime:Ljava/lang/String;
    .end local v8           #defaultTime:Ljava/lang/String;
    .end local v9           #delayFocusTime:Ljava/lang/String;
    .end local v10           #delayTime:Ljava/lang/String;
    .end local v11           #flashMode:Ljava/lang/String;
    .end local v24           #supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    const-string v28, "pref_camera_redeyereduction_key"

    const v29, 0x7f0d00cc
    ...
    .line 2368
    .local v20, redeyeReduction:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getSupportedRedeyeReductionModes()Ljava/util/List;
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/Camera$Parameters;->setRedeyeReductionMode(Ljava/lang/String;)V
    ...
    const-string v28, "pref_camera_coloreffect_key"

    const v29, 0x7f0d00d7
    ...
    const-string v29, "Color effect value ="
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getSupportedColorEffects()Ljava/util/List;

    move-result-object v27

    move-object/from16 v0, v27

    invoke-static {v6, v0}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    const-string v28, "pref_camera_autoexposure_key"

    const v29, 0x7f0d00c6
    ...
    const-string v29, "autoExposure value ="
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getSupportedAutoexposure()Ljava/util/List;

    move-result-object v27

    move-object/from16 v0, v27

    invoke-static {v5, v0}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v0, v5}, Landroid/hardware/Camera$Parameters;->setAutoExposure(Ljava/lang/String;)V
    ...
    const-string v29, "antiBanding value ="
    ...
    invoke-static {v4, v0}, Lcom/android/camera/Camera;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getFocusMode()Ljava/lang/String;

    move-result-object v27

    const-string v28, "continuous-picture"
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/camera/CameraManager$CameraProxy;->setAutoFocusMoveCallback(Landroid/hardware/Camera$AutoFocusMoveCallback;)V
    ...
    .end local v13           #jpegQuality:I
    .end local v14           #max:I
    .end local v15           #min:I
    .end local v17           #optimalSize:Landroid/hardware/Camera$Size;
    .end local v18           #original:Landroid/hardware/Camera$Size;
    .end local v20           #redeyeReduction:Ljava/lang/String;
    ...
    .line 2233
    .local v16, oldSize:Landroid/hardware/Camera$Size;
    move-object/from16 v0, p0
    ...
    .line 2234
    .local v23, supported:Ljava/util/List;,"Ljava/util/List<Landroid/hardware/Camera$Size;>;"
    move-object/from16 v0, p0
    ...
    iget v0, v0, Lcom/android/camera/Camera;->mCameraState:I
    ...
    const-string v28, "Picture size changed. Restart preview"
    ...
    iput-boolean v0, v1, Lcom/android/camera/Camera;->mAspectRatioChanged:Z
    ...
    .line 2278
    .end local v16           #oldSize:Landroid/hardware/Camera$Size;
    .end local v23           #supported:Ljava/util/List;,"Ljava/util/List<Landroid/hardware/Camera$Size;>;"
    .restart local v17       #optimalSize:Landroid/hardware/Camera$Size;
    .restart local v18       #original:Landroid/hardware/Camera$Size;
    ...
    .restart local v13       #jpegQuality:I
    ...
    .line 2326
    .restart local v11       #flashMode:Ljava/lang/String;
    .restart local v24       #supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_13
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/hardware/Camera$Parameters;->getFlashMode()Ljava/lang/String;
    ...
    .restart local v20       #redeyeReduction:Ljava/lang/String;
    :cond_16
    move-object/from16 v0, p0
...
.method private updateTimer(I)V
    ...
    .line 1676
    iget-object v1, p0, Lcom/android/camera/Camera;->mRecordingTimeView:Landroid/widget/TextView;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/camera/PreviewFrameLayout;->setCameraOrientation(I)V
...
.method public onShutterButtonClick()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/ShutterButton;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/camera/Camera;->updateTimer(I)V
    ...
    iget-wide v3, p0, Lcom/android/camera/Camera;->mStorageSpace:J
