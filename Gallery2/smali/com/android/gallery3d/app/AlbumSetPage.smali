...
.method private pickAlbum(I)V
    ...
    .line 218
    iget-object v7, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mActivity:Lcom/android/gallery3d/app/GalleryActivity;
...
.method public doCluster(I)V
    ...
    .line 264
    iget-object v3, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mActivity:Lcom/android/gallery3d/app/GalleryActivity;
...
.method protected onCreateActionBar(Landroid/view/Menu;)Z
    ...
    iget-object v9, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mActivity:Lcom/android/gallery3d/app/GalleryActivity;

    invoke-interface {v9}, Lcom/android/gallery3d/app/GalleryActivity;->getStateManager()Lcom/android/gallery3d/app/StateManager;
    ...
    invoke-virtual {v4, v9, p1}, Landroid/view/MenuInflater;->inflate(ILandroid/view/Menu;)V

    .line 419
    iget-object v9, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mData:Landroid/os/Bundle;

    const-string v10, "type-bits"
    ...
    :cond_0
    :goto_0
    iget-object v9, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mActionBar:Lcom/android/gallery3d/app/GalleryActionBar;

    invoke-virtual {v9, v2}, Lcom/android/gallery3d/app/GalleryActionBar;->setTitle(I)V
    ...
    const v10, 0x7f0d013e

    invoke-virtual {v9, v10}, Lcom/android/gallery3d/app/GalleryActionBar;->setTitle(I)V
    ...
    :goto_2
    iput-boolean v9, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mShowClusterMenu:Z
    ...
    .line 436
    .local v6, selectItem:Landroid/view/MenuItem;
    if-eqz v6, :cond_4
    ...
    invoke-virtual {v9}, Lcom/android/gallery3d/app/GalleryActionBar;->getClusterTypeAction()I
    ...
    invoke-static {v9, v10, v11}, Lcom/android/gallery3d/app/FilterUtils;->setupMenuItems(Lcom/android/gallery3d/app/GalleryActionBar;Lcom/android/gallery3d/data/Path;Z)V
    ...
    .line 448
    .local v7, switchCamera:Landroid/view/MenuItem;
    if-eqz v7, :cond_5
    ...
    const v10, 0x7f0d01ab

    invoke-static {v9, v1, v10}, Lcom/android/gallery3d/util/HelpUtils;->prepareHelpMenuItem(Landroid/content/Context;Landroid/view/MenuItem;I)Z
    ...
    invoke-virtual {v9, v10}, Lcom/android/gallery3d/app/GalleryActionBar;->setTitle(Ljava/lang/String;)V

    .line 456
    iget-object v9, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mActionBar:Lcom/android/gallery3d/app/GalleryActionBar;

    iget-object v10, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mSubtitle:Ljava/lang/String;

    invoke-virtual {v9, v10}, Lcom/android/gallery3d/app/GalleryActionBar;->setSubtitle(Ljava/lang/String;)V

    goto :goto_1

    .line 432
    .end local v1           #helpMenu:Landroid/view/MenuItem;
    .end local v6           #selectItem:Landroid/view/MenuItem;
    .end local v7           #switchCamera:Landroid/view/MenuItem;
    :cond_6
    const/4 v9, 0x0
    ...
    .line 437
    .restart local v6       #selectItem:Landroid/view/MenuItem;
    :cond_7
    const/4 v5, 0x0
    ...
    .line 442
    .restart local v5       #selectAlbums:Z
    :cond_8
    const v9, 0x7f0d013f
...
.method protected onItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 470
    :sswitch_1
    iget-object v5, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mSelectionManager:Lcom/android/gallery3d/ui/SelectionManager;

    invoke-virtual {v5, v4}, Lcom/android/gallery3d/ui/SelectionManager;->setAutoLeaveSelectionMode(Z)V

    .line 471
    iget-object v4, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mSelectionManager:Lcom/android/gallery3d/ui/SelectionManager;

    invoke-virtual {v4}, Lcom/android/gallery3d/ui/SelectionManager;->enterSelectionMode()V

    goto :goto_0

    .line 474
    :sswitch_2
    iget-object v5, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mAlbumSetDataAdapter:Lcom/android/gallery3d/app/AlbumSetDataLoader;

    invoke-virtual {v5}, Lcom/android/gallery3d/app/AlbumSetDataLoader;->size()I
    ...
    .line 475
    iget-boolean v4, p0, Lcom/android/gallery3d/app/AlbumSetPage;->mShowDetails:Z
    ...
    const-class v5, Lcom/android/gallery3d/app/ManageCachePage;
